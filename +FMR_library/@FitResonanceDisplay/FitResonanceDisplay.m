classdef FitResonanceDisplay < handle
    ...
    properties (Access = private, Hidden)
        ...
        minRsqrField (1,1)
        minRsqrLabel (1,1)
        backgroundPolyDeg (1,1)
        backgroundPolyDegLabel (1,1)
        rsqrLabel(1,1)
        rsqrDisp (1,1)
        plotRangeField (1,1)
        plotRangeLabel (1,1)
    ...
    methods
        function obj = FitResonanceDisplay()
            ...
            obj.autoFitFrame = annotation("textbox", ...
                                          ...
                                          "LineWidth", 1.5, ...
                                          "Visible", "on");
            obj.backgroundPolyDeg = uicontrol('Style', 'popupmenu', ...
                                              'String', {'0', '1', '2'}, ...
                                              'Value', 2, ...
                                              'FontUnits','normalized', ...
                                              'FontSize', 0.8, ...
                                              'Units', 'normal', ...
                                              'Position', [0.18 0.02 0.02 0.025], ...
                                              'Parent', obj.figureHandle, ...
                                              'KeyPressFcn', @obj.keyPressCallback);
            obj.backgroundPolyDegLabel = uicontrol('Style', 'text', ...
                                               'String', 'Background deg.', ...
                                               'Tooltip', 'The fit model will fit a background with a polynomial expression of this degree',  ...
                                               'FontUnits','normalized', ...
                                               'FontSize', 0.8, ...
                                               'Units', 'normal', ...
                                               'Position', [0.1 0.015 0.08 0.025], ...
                                               'Parent', obj.figureHandle, ...
                                               'KeyPressFcn', @obj.keyPressCallback);
        ...
        function out = get.backgroundDeg(obj)
        %GET.BACKGROUNDDEG Returns a the degree of the polynomial to fit background
            out = obj.backgroundPolyDeg.Value - 1;
        end
